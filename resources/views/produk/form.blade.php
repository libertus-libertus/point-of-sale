            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="stok" id="stok" class="form-control" required value="0" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-flat btn-primary btn-xs"><i class="fa fa-save"></i> Simpan</button>
                    <button type="button" class="btn btn-flat btn-warning btn-xs" data-dismiss="modal"><i
